package com.example.coroutinesandmultithreadingimplementation.androidcoroutinesmasterclass
...
import com.example.coroutinesandmultithreadingimplementation.androidcoroutinesmasterclass.base.*
import com.example.coroutinesandmultithreadingimplementation.databinding.ActivityCoroutineOneBinding

class CoroutineOneActivity : BaseActivity() {
    ...
    private fun initRecyclerView() {
        binding.recyclerView.apply {
            ...
            hasFixedSize()
            layoutManager = LinearLayoutManager(this@CoroutineOneActivity)
